...
namespace BloodDonations.Api.Models
{
    ...
    public partial class BloodDonationsEntities : DbContext
    {
        public BloodDonationsEntities()
            : base("name=BloodDonationsEntities")
        {
        }
        ...
        public virtual DbSet<UserDonationHistory> UserDonationHistory { get; set; }
    }
}
